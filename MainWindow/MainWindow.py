...
from MonthEndReport import MonthEndReport
...
class MainWindow(wx.Frame):
    ...
    def __init__(self, parent):
        self.i = 0
        wx.Frame.__init__(self, parent, id=-1, title=u"专用工具", pos=wx.Point(3300 - 1980, 110),
        ...
        self.m_dirPicker1_文件路径选择器 = wx.DirPickerCtrl(self, wx.ID_ANY,
                                                            u"C:\\Users\\admin\\Desktop\\新建文件夹\\工作表",
                                                            u"请选择工作表目录",
    ...
    def start(self, event):
        ...
        print("点击了开始按钮")
        # print(type(self))
        MonthEndReport.start(self, self.m_dirPicker1_文件路径选择器.GetPath(), wx)
        event.Skip()
